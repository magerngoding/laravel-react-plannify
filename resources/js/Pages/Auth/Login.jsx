                        ...
                        <form className="space-y-6" onSubmit={submit}>
                            ...
                            <div>
                                ...
                                <TextInput
                                    ...
                                    className='block w-full mt-1' isFocused={true} onChange={(e) => setData('email', e.target.value)} onErrors={errors.email && <InputError className='mt-1' message={errors.email} />}
                                />
                            </div>
                            <div>
                                <div className='flex items-center justify-between'>
                                    ...
                                    {canResetPassword && (
                                        <div className='text-sm'>
                                            <Link href='#' className='font-semibold text-red-500 hover:text-red-600'>Forgot your password?
                                            </Link>
                                        </div>
                                    )}
                                </div>
                                <div>
                                    <TextInput
                                        ...
                                        className='block w-full mt-1' onChange={(e) => setData('password', e.target.value)} onErrors={errors.password && <InputError className='mt-1' message={errors.password} />}
                                    />
                                </div>
                            </div>

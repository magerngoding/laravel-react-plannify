                                ...
                                <form className="space-y-6" onSubmit={submit}>
                                    ...
                                    <div>
                                        ...
                                        <TextInput
                                            ...
                                            type='text'
                                            value={data.name}
                                            className='block w-full mt-1' isFocused={true}
                                            onChange={(e) => setData('name', e.target.value)}
                                            onErrors={errors
                                                .name && <InputError message={errors.name} className='mt-2'
                                                />}
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <TextInput
                                            ...
                                            name='email'
                                            type='email'
                                            value={data.email} className='block w-full mt-1'
                                            onChange={(e) => setData('email', e.target.value)} onErrors={errors
                                                .email && <InputError message={errors.email} className='mt-2'
                                                />}
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <TextInput
                                            ...
                                            name='password'
                                            type='password'
                                            value={data.password} className='block w-full mt-1'
                                            onChange={(e) => setData('password', e.target.value)} onErrors={errors
                                                .password && <InputError message={errors.password} className='mt-2'
                                                />}
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <TextInput
                                            ...
                                            type='password'
                                            value={data.password_confirmation} className='block w-full mt-1'
